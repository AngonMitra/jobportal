	...
	<div style="border: 2px solid #DDD; width: 355px; height:450px;padding-left:10px;float:left; margin-top:0px;">
	  ...
	  <ul>
		...
		<br>
		   ...
		   <li>
		   <a href="" class="btn">Apply Application</a></li>
		...
		<label style="padding-left:200px; font-size:50px; color:green;">Apply Job Application</label>
		<br>
		<br>
		<br>
		<br>
                  ...
                  <table id="example2" class="table table-hover" style="padding-left:100px; width:700px;">
                    <thead>
					  ...
					  <th style="font-size:30px;" >Deadline</th>
					   <th style="font-size:30px;" >Resume</th>
                    </thead>
					<br>
                    <tbody>
<?php
...
include ("db_connect.php");
   ...
   $q = "select * from applyjob where 1";
   $row = mysql_query($q);
...
?>
     ...
     <tr>
	   ...
	   <td style="font-size:20px;padding-left:80px;"><?php echo  $r['comtype']; ?></td>
		...
		<td class="blaaa"><a href="resume/<?php echo $r['resume']; ?>" target="_blank">View Here</a></td>
		</tr>
	<?php
  }
