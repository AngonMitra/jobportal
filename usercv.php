...
if (isset($_POST['usubmit']))
{
	...
	if ($location=='')
	{
		...
		$query ="insert into usercv (fname,email,number,address,edlevel,result,department,pyear,inname,grade,career,caricular,selectskill,salary,skilldes,fathername,birthdate,gen,marital,nationality,religion,paddress,location,uname)                                        
	              values ('$fname','$email','$number','$address','$edlevel','$result','$department','$pyear','$inname','$grade','$career','$caricular','$selectskill','$salary','$skilldes','$fathername','$birthdate','$gen','$marital','$nationality','$religion','$paddress','$location','$uname')";           
	
	if(mysql_query($query))
	{
		echo "<script>alert ('CV complete')</script>";
  ...
  <br>
	...
	<br>
	  ...
	  <ul>
		...
		<div style="border: 2px solid #DDD; width: 680px; height:2530px;padding-left:95px;float:right; margin-top:0px;">
		<br>
		
		
		  <center>
		       <label style="padding-left:0px; font-size:50px; color:green;">§ Create Resume</label>
		  </center>
		  
		  <br>
		  <br>
		  
		 <div style="border: 1px solid #DDD; width: 680px; height:570px;padding-left:95px;float:right; margin-top:0px;">
...
?>
 ...
 <script type="text/javascript">
	  ...
	  function updatepicture(pic){
		  ...
		  <div style="border: 1px solid #DDD; width: 765px; height:300px;padding-left:10px;float:right; margin-top:20px;">
		    
			<br>
			 <label style="padding-left:0px; font-size:30px; color:;"><b><i>§ Academic Summary :</i></b></label>
			...
			<br>
			 <select name="edlevel">
				...
				<input style="padding-left:20px;" type="text" name="grade" placeholder="Grade"><br>
                 ...
                 <div style="border: 1px solid #DDD; width: 765px; height:600px;padding-left:10px;float:right; margin-top:10px;">
		    
			<br>
			 <label style="padding-left:0px; font-size:30px; color:;"><b><i>§ Career Objective :</i></b></label>
			 <br>
			 <br>
			  ...
			  <br>
			   ...
			   <label style="padding-left:0px; font-size:30px; color:;"><b><i>§ Extra Caricular Activities :</i></b></label>
			   <br>
			   <br>
			 ...
			 <div style="border: 1px solid #DDD; width: 765px; height:450px;padding-left:10px;float:right; margin-top:0px;">
			 <br>
			 <label style="padding-left:0px; font-size:30px; color:;"><b><i>§ Specialization :</i></b></label>
			 <br>
			 <br>
			...
			<select name="salary">
					 ...
					 <br>
					  <br>
			 <label style="padding-left:0px; font-size:30px; color:;"><b><i>§ Description :</i></b></label>
			 <br>
			 <br>
	...
	<div style="border: 1px solid #DDD; width: 765px; height:470px;padding-left:10px;float:right; margin-top:0px;">
			 <br>
			 <label style="padding-left:0px; font-size:30px; color:;"><b><i>§ Personal Details :</i></b></label>
			 <br>
			 <br>
			 <div style="padding-left: 80px;">
