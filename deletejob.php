	...
	<div style="border: 2px solid #DDD; width: 355px; height:450px;padding-left:10px;float:left; margin-top:0px;">
	  ...
	  <ul>
		...
		<li>
		 ...
		 <li>
		   <a href="" class="btn" style="width:200px;">Delete Job</a></li><br>
		...
		<label style="padding-left:200px; font-size:50px; color:green;">Delete Your Posted Job</label>
		<br>
		<br>
		<br>
		<br>
		<div class="box-body table-responsive no-padding" >
                  <table id="example2" class="table table-hover" style="padding-left:100px; width:700px;">
                    <thead>
...
?>
     ...
     <tr>
	   ...
	   <td style="font-size:20px;padding-left:50px;"><?php echo  $r['deadline']; ?></td>
	    <td style="font-size:20px;padding-left:50px;"><?php echo  $r['jobnature']; ?></td>
	 ...
	 
{
	...
	$q="delete  from jobpost where  uname='$uname'";
	
	if(mysql_query($q))
	{
		echo "<script>alert ('Your Job is Delete Successfully')</script>";
